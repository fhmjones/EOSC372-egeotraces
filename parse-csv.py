...
data = [GIPY05_data['Station'], GIPY05_data['yyyy-mm-ddThh:mm:ss.sss'], GIPY05_data['Latitude [degrees_north]'], GIPY05_data['Longitude [degrees_east]'],
        GIPY05_data['DEPTH [m]'], GIPY05_data['CTDTMP [deg C]'], GIPY05_data['CTDSAL'], GIPY05_data['NO2+NO3_D_CONC_BOTTLE [umol/kg]'],
...
data = [GP02_data['Station'], GP02_data['yyyy-mm-ddThh:mm:ss.sss'], GP02_data['Latitude [degrees_north]'], GP02_data['Longitude [degrees_east]'],
        GP02_data['DEPTH [m]'], GP02_data['CTDTMP [deg C]'], GP02_data['CTDSAL'], GP02_data['NO2+NO3_D_CONC_BOTTLE [umol/kg]'],
...
data = [GIPY04_data['Station'], GIPY04_data['yyyy-mm-ddThh:mm:ss.sss'], GIPY04_data['Latitude [degrees_north]'], GIPY04_data['Longitude [degrees_east]'],
        GIPY04_data['DEPTH [m]'], GIPY04_data['CTDTMP [deg C]'], GIPY04_data['CTDSAL'], GIPY04_data['NITRATE_D_CONC_BOTTLE [umol/kg]'],
