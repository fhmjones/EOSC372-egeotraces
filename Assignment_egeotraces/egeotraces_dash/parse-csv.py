...
data = [GA03_data['Station'], GA03_data['Latitude [degrees_north]'], GA03_data['Longitude [degrees_east]'], GA03_data['DEPTH [m]'],
        GA03_data['CTDTMP [deg C]'], GA03_data['CTDSAL'], GA03_data['NITRATE_D_CONC_BOTTLE [umol/kg]'], GA03_data['Fe_D_CONC_BOTTLE [nmol/kg]']]
GA03 = pd.concat(data, axis=1, keys=headers)
#remove unwanted lons and lats
GA03 = GA03[((GA03.Longitude <= 360-60) & (GA03.Longitude >= 360-65)) | ((GA03.Longitude <= 360) & (GA03.Longitude >= 360-25))]
GA03.to_csv('GA03_filtered.csv', index=False)



# make GIPY05 dataframe and csv
data = [GIPY05_data['Station'], GIPY05_data['Latitude [degrees_north]'], GIPY05_data['Longitude [degrees_east]'], GIPY05_data['DEPTH [m]'],
        GIPY05_data['CTDTMP [deg C]'], GIPY05_data['CTDSAL'], GIPY05_data['NO2+NO3_D_CONC_BOTTLE [umol/kg]'], GIPY05_data['Fe_D_CONC_BOTTLE [nmol/kg]']]
...
data = [GP02_data['Station'], GP02_data['Latitude [degrees_north]'], GP02_data['Longitude [degrees_east]'], GP02_data['DEPTH [m]'],
        GP02_data['CTDTMP [deg C]'], GP02_data['CTDSAL'], GP02_data['NO2+NO3_D_CONC_BOTTLE [umol/kg]'], GP02_data['Fe_D_CONC_BOTTLE [nmol/kg]']]
...
data = [GIPY04_data['Station'], GIPY04_data['Latitude [degrees_north]'], GIPY04_data['Longitude [degrees_east]'], GIPY04_data['DEPTH [m]'],
        GIPY04_data['CTDTMP [deg C]'], GIPY04_data['CTDSAL'], GIPY04_data['NITRATE_D_CONC_BOTTLE [umol/kg]'], GIPY04_data['Fe_D_CONC_BOTTLE [nmol/kg]']]
